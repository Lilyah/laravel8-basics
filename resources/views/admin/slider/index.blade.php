                                ...
                                <tbody>
                                    ...
                                    @foreach($sliders as $slider)
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              <a href="{{ url('slider/edit/'.$slider->id) }}" class="btn btn-info" style="color:white">Edit</a>
                                              <a href="{{ url('slider/delete/'.$slider->id)  }}" onclick="return confirm('Are you sure you want to delete this Slider?')" class="btn btn-danger">Delete</a>
                                          </td>
                                        </tr>
