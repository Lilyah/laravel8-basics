...
<head>
  ...
  <body class="bg-light-gray" id="body">
                ...
                <div class="card-header bg-primary">
                  <div class="app-brand">
                    <a href="/index.html">
                      ...
                      <span class="brand-name">LilyahDev Dashboard</span>
                    </a>
                  </div>
                </div>
          ...
          <div class="copyright pl-0">
            <p class="text-center">&copy; 2021 Copyright LilyahDev Dashboard
              <a class="text-primary" href="http://www.lilyah.dev/" target="_blank">LilyahDev</a>.
            </p>
          </div>
        </div>
</body>
